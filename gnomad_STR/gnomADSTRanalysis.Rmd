...
#### STRATIFY BY SEX FOR X-LINKED (eg, DMD)
#### Look at AD, AR
...
df_with_ci <- calculate_ci(sex_result, successes_col = "Allele2>pathogenic_min", trials_col = "Total_Allele2Loci_for_Id", conf_level = 0.95)

df_with_ci$lower_ci <- df_with_ci$lower_ci*100 
df_with_ci$upper_ci <- df_with_ci$upper_ci*100 
...
#### CHECK IF ALLELE2 is NA, do table of ALLELE1 -- if they're small or NAs, whatever, but if they're big?? -- check if on X chromosome
