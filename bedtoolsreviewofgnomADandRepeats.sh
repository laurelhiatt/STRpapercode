...
# awk -F'\t' -v values="chr1 chr2 chr3 chr4 chr5 chr6 chr7 chr8 chr9 chr10 chr11 chr12 chr13 chr14 chr15 chr16 chr17 chr18 chr19 chr20 chr21 chr22 chrX chrY" 'BEGIN { split(values, arr, " ") } $1 ~ "^("arr[1]"|"arr[2]"|"arr[3]"|"arr[4]"|"arr[5]"|"arr[6]"|"arr[7]"|"arr[8]"|"arr[9]"|"arr[10]"|"arr[11]"|"arr[12]"|"arr[13]"|"arr[14]"|"arr[15]"|"arr[16]"|"arr[17]"|"arr[18]"|"arr[19]"|"arr[20]"|"arr[21]"|"arr[22]"|"arr[23]"|"arr[24]")$" { print }' ucscrepeatmaskerhg38.bed > ucscrepeatmaskerhg38_filtered.bed
